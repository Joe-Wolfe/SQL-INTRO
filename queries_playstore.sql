...
--been installed at least 100,000 times. Display the name of the app along with the number of reviews, 
-- the min_installs, and the proportion. --

SELECT app_name, reviews, min_installs, TRUNC(reviews*1.0/min_installs, 5) AS porportion
FROM analytics
